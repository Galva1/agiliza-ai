...
--   - Tabelas no plural, em português.
--   - Colunas com prefixo por tipo: id_x (chave primária/estrangeira),
--     nm_x (nome/texto curto), ds_x (descrição/texto longo),
--     dt_x (data/hora), fl_x (flag booleana).
-- =====================================================================
